...
class functionConan(ConanFile):
    ...
    def package_info(self):
        self.cpp_info.libs = ["function"]
        self.cpp_info.name["cmake_find_package"] = "function"
        self.cpp_info.names["cmake_find_package_multi"] = "function"
